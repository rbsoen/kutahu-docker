...
{ 
  ...
  if (browserVersion > 0) 
    auxEv = "<a class='MyTree'  class='MyTree'  href='javascript:clickOnNode(\""+this.getID()+"\")'>" 
  else 
    auxEv = "<a class='MyTree'  class='MyTree' >" 
...
//debo	
	if(USETEXTLINKSTITLE)
	{

		MyStr=this.desc 
		if(MyStr.length>30)
		{
			MyStr=MyStr.substr(0,30)+".."
		    docW = docW + MyStr+ "</a>"
		}
		else
		{
...
{ 
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<a class='MyTree'  href='" + this.hreference + "' TARGET=\"basefrm\" "
	else
	  docW = docW + "<a class='MyTree'  href='" + this.hreference + "' TARGET=_top "
...
{ 
  ...
  docW = docW + "<tr>" + leftSide + "<td valign=top>"
  if (USEICONS)
      docW = docW + "<a class='MyTree'  " + fullLink  + " id=\"itemIconLink"+this.id+"\">" + "<img id='itemIcon"+this.id+"' " + "src='"+this.iconSrc+"' border=0>" + "</a>"
  else
	  if (this.prependHTML == "")
  ...
  if (USETEXTLINKS) 
	...
	if(USETEXTLINKSTITLE)
	{
		...
		if(MyStr.length>30)
		{
		    ...
		    docW = docW + "<a class='MyTree'  " + fullLink + " id=\"itemTextLink"+this.id+"\" title=\""+this.desc+"\">" + MyStr+"</a>"
		}
		else
		{

		    docW = docW + "<a class='MyTree'  " + fullLink + " id=\"itemTextLink"+this.id+"\" title=\""+this.desc+"\">" + this.desc + "</a>"
		}
	} else 
	{
	    docW = docW + "<a class='MyTree'  " + fullLink + " id=\"itemTextLink"+this.id+"\">" + this.desc + "</a>"
	}
	//debo
  else 
    docW = docW + this.desc
