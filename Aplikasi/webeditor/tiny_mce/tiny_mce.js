...
var attrib = new Object();
			...
			attrib.value =tinyMCE.convertAbsoluteURLToRelativeURL(tinyMCE.settings['document_base_url'],attribValue);
...
function TinyMCE_insertLink(href, target, title) {
	...
	//debo :change #mce_temp_url# to href
		this.selectedInstance.contentDocument.execCommand("createlink", false, href);

		tinyMCE.linkElement = this.getElementByAttributeValue(this.selectedInstance.contentDocument.body, "a", "href", href);

			var elementArray = this.getElementsByAttributeValue(this.selectedInstance.contentDocument.body, "a", "href", href);
...
function TinyMCE_insertImage(src, alt, border, hspace, vspace, width, height, align) {
	...
	if (!this.imgElement && this.selectedInstance) {
		//debo :change #mce_temp_url# to src		
		this.selectedInstance.contentDocument.execCommand("insertimage", false, src);
		tinyMCE.imgElement = this.getElementByAttributeValue(this.selectedInstance.contentDocument.body, "img", "src", src);
...
function TinyMCE_getContent(editor_id) {
	...
	if (tinyMCE.selectedInstance) {
		...
		return this.selectedInstance.contentWindow.document.body.innerHTML
	}
