...
// -------------------------
    global $lblTopLink;
	$MyLink="";
	$MyLink=$MyLink."<a class='CobaltDataLinkTop' href=\"SelectPageCategory.php". "?" . CCGetQueryString("QueryString", Array("KnowAreaID","CatID","ccsForm"))."\">Daftar Bab</a>";
	$MyLink=$MyLink." > <a class='CobaltDataLinkTop' href=\"SelectPageKnowArea.php". "?" . CCGetQueryString("QueryString", Array("KnowAreaID","ccsForm"))."\">Daftar Sub Bab</a>";
