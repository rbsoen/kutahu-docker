...
//Class_Initialize Event @2-0B75E410
    ...
    function Show()
    {
        ...
        if($is_next_record && $ShownRecords < $this->PageSize)
        {
            do {
                ...
                $this->ImageLink1->Page = "SelectPageKnowArea.php";
...
//DataSource Variables @2-5E0E2C09
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    var $BlockExecution;
...
//Class_Initialize Event @2-1DFE8C47
...
$FileName = "SelectPageCategory.php";
$Redirect = "";
$TemplateFileName = "SelectPageCategory.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page

//Initialize Objects @1-A499DB6E
...
// Events
include("./SelectPageCategory_events.php");
BindEvents();
